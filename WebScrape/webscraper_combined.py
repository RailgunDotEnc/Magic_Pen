# -*- coding: utf-8 -*-
"""
Created on Tue Nov  7 12:59:25 2023
...
# -*- coding: utf-8 -*-
"""
Created on Wed Nov  1 22:19:31 2023
...
def download_image2(download_path, url, file_name, res):
    try:
        image_content = requests.get(url).content
        image_file = io.BytesIO(image_content)
        image = Image.open(image_file)
...
for i, url in enumerate(urls):
    if not download_image("imgs/", url, str(i) + ".png", 512):
        num_failed += 1
    if not download_image2("imgs/", url, str(i) + "_scribble.png", 5000):
        num_failed += 1
